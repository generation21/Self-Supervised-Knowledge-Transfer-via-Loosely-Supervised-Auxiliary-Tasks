...
# New Add#
    ...
    parser.add_argument(
        ...
        default=1000,
        type=int,
        help='source network output num 1000 | 365')
    parser.add_argument(
        '--layer_num',
        default='b4',
        type=str,
        help='Transfer Modeul layer') 
    parser.add_argument(
        '--sourceKind',
        default='imagenet',
        type=str,
        help='imagenet | places') 
    parser.add_argument(
        '--source_arch',
        default='resnet50',
        type=str,
    ...
    parser.add_argument(
        ...
        default='ce',
        type=str,
        help=' ce (Cross Entropy loss) | f (Focal loss) ') 
    parser.add_argument(
    ...
    parser.add_argument(
        '--T',
        default=1.0, type=float, help='pretrained model'
    )
    parser.add_argument(
        '--alpha',
        default=1.0, type=float, help='pretrained model'
